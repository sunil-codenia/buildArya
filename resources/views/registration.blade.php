        ...
        <div class="col-md-12 content-center">
          ...
          @endisset
            <div class="card-plain">
                ...
                <form class="form" method="POST" action="{{url('/register_new_user')}}">
                    @csrf
                    ...
                    <div class="content">                                                
                        ...
                        <div class="input-group input-lg">
                            <input type="text" class="form-control" name="contact_no" required placeholder="Enter Phone No">
                            <span class="input-group-addon">
                                <i class="zmdi zmdi-account-circle"></i>
                            </span>
                        </div>
                        <div class="input-group input-lg">
                            <input type="text" class="form-control" name="pan_no" required placeholder="Enter PAN No">
                            <span class="input-group-addon">
                                <i class="zmdi zmdi-account-circle"></i>
                            </span>
                        </div>
