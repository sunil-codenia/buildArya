<div class="card">
    <div class="header">
        <h2><strong>Site Bills</strong> Report</h2>
    </div>
    @php $data = get_site_bill_area_chart_widget_data($id, $from ?? null, $to ?? null);
    $workdata = get_site_bills_area_chart_work_table($id, $from ?? null, $to ?? null);
    $count=0;
    @endphp
    <div class="body">
