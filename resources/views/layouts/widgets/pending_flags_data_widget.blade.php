<div class="row clearfix">
    @php
    $data = get_company_pending_flags_data_widget($from ?? null, $to ?? null);
    @endphp
        ...
        <div class="card">
            ...
            <ul class="row profile_state list-unstyled">
                <li class="col-lg-3 col-md-3 col-6">
                    <div class="body">
                        <a href="/pending_expense?from_date={{$from}}&to_date={{$to}}&site_id=all">
                ...
                <li class="col-lg-3 col-md-3 col-6">
                    <div class="body">
                        <a href="/pending_material?from_date={{$from}}&to_date={{$to}}&site_id=all">
                ...
                <li class="col-lg-3 col-md-3 col-6">
                    <div class="body">
                        <a href="/pending_bill?from_date={{$from}}&to_date={{$to}}&site_id=all">
                ...
                <li class="col-lg-3 col-md-3 col-6">
                    <div class="body">
                        <a href="/pending_paymentvoucher?from_date={{$from}}&to_date={{$to}}&site_id=all">
                ...
                <li class="col-lg-3 col-md-3 col-6">
                    <div class="body">
                        <a href="/verified_paymentvoucher?from_date={{$from}}&to_date={{$to}}&site_id=all">
                ...
                <li class="col-lg-3 col-md-3 col-6">
                    <div class="body">
                        <a href="/expense_party?status=Pending&from_date={{$from}}&to_date={{$to}}&site_id=all">
                ...
                <li class="col-lg-3 col-md-3 col-6">
                    <div class="body">
                        <a href="/billparty?status=Pending&from_date={{$from}}&to_date={{$to}}&site_id=all">
