...
@section('content')
    ...
    @include('templates.blockheader', ['pagename' => 'Company Dashboard'])
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            ...
            @include('layouts.widgets.total_sites_data_widget')

            @include('layouts.widgets.company_monthly_expense_data_widget')
            @include('layouts.widgets.total_employee_data_widget')

        </div>
        @include('layouts.widgets.pending_flags_data_widget')



        <div class="row clearfix">
            @include('layouts.widgets.company_sales_invoices_chart_widget')
            @include('layouts.widgets.company_payment_voucher_chart_widget')
        ...
        <div class="row clearfix">
            <div class="col-lg-6 col-md-12">
                @include('layouts.widgets.company_expense_area_chart_widget')


            </div>
            <div class="col-lg-6 col-md-12">
                @include('layouts.widgets.company_site_bills_area_chart_with_work_table')

            </div>
        </div>
        <div class="row"> @include('layouts.widgets.company_asset_list_table_widget')
            @include('layouts.widgets.company_machinery_list_table_widget')</div>
    </div>
@endsection
...
@section('chart_scripts')
    @php
        $monthlyExpensesFormatted = get_company_monthlyExpensesFormatted_chart_widget($from_chart, $to_chart);
        $sale_invoices_data = get_company_sales_invoices_chart_widget($from_chart, $to_chart);
        $site_bills_yearly_data = get_company_site_bills_area_chart($from_chart, $to_chart);
        $payment_voucher_chart_yearly_data = get_company_payment_voucher_chart_widget($from_chart, $to_chart);
        $payment_voucher_chart_complete_data = get_company_payment_voucher_chart_complete_widget($from_chart, $to_chart);
    @endphp
    ...
    <script type="text/javascript">
        ...
        function ExpenseAreaChart() {
            ...
            return 'Month : <b>' + data.period + '</b><br>Bill Amount : ' + formatAmountInRs(data.expense); // Customize this string as needed
        },
            });
     ...
     // Function to lighten or darken a color by a random percentage
