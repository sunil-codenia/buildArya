@extends('app')
@section('content')
    @include('templates.blockheader', ['pagename' => 'New Bill Entry'])
    @php
            ...
            <div class="card project_list">
                ...
                @if(checkmodulepermission(4,'can_add') == 1)
                    <div class="modal-body">
                        <form method="post" action="{{ url('/addnewbill') }}" enctype="multipart/form-data">
                            @csrf
                            <hr>
                            <div class="row clearfix">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="form-group">
                                                <label>Site&nbsp;<sub id="sitealert" style="color:red; display:none;">Alert : Changing Site Will Remove All Bill Items</sub></label>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="form-group">
                                                <label>Bill No.</label>
                                                <input type="text" required value = "{{getLatestBillNo()}}" class="form-control" name="bill_no"
...
<hr>
                    ...
                    @else
                    <div class="alert alert-danger">You Don't Have Permission to Add bill</div>
                    @endif
                </div>
