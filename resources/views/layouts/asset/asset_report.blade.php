    ...
    <div class="row clearfix">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="card project_list">
                <p class="header"><strong>Asset Complete Report According To Site</strong></p>
                <form method="post" action="{{ url('/asset_of_site_report') }}" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card project_list">
                    <p class="header"><strong>Asset Purchase Report According To Head</strong></p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="head_id" class="form-control show-tick" data-live-search="true"
                                            ...
                                            @foreach ($asset_heads as $asset_head)
                                                <option value="{{ $asset_head->id }}">{{ $asset_head->name }}
                                                </option>
                                            @endforeach
                                        </select>
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card project_list">
                    <p class="header"><strong>Asset Purchase Report According To Site</strong></p>
                    <form method="post" action="{{ url('/assetreport') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row clearfix">
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card project_list">
                    <p class="header"><strong>Complete Asset Purchase Report</strong></p>
                    <form method="post" action="{{ url('/assetreport') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row clearfix">
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card project_list">
                    <p class="header"><strong>Asset Sale Report According To Head</strong></p>
                    <form method="post" action="{{ url('/assetreport') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row clearfix">
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card project_list">
                    <p class="header"><strong>Asset Sale Report According To Site</strong></p>
                    <form method="post" action="{{ url('/assetreport') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row clearfix">
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card project_list">
                    <p class="header"><strong>Asset Complete Sale Report</strong></p>
                    <form method="post" action="{{ url('/assetreport') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row clearfix">
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card project_list">
                    <p class="header"><strong>Asset Transfer Report According To Head</strong></p>
                    <form method="post" action="{{ url('/assetreport') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row clearfix">
        ...
        <div class="row clearfix">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="card project_list">
                    <p class="header"><strong>Asset Complete Transfer Report</strong></p>
                    <form method="post" action="{{ url('/assetreport') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="row clearfix">
