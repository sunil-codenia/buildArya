@extends('app')
@section('content')
    @include('templates.blockheader', ['pagename' => 'Edit Material Wastage'])
    @php
                ...
                @if (checkmodulepermission(3, 'can_edit') == 1)
                    <div class="modal-content">
                        <div class="modal-body">
                            <form method="post" action="{{ url('/updatewastageEntry') }}" enctype="multipart/form-data">
                                @csrf
                                <hr>
                                <div class="row clearfix">
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <img height= "150" width="150" id="user_image"
                                                src="{{ asset($wastage->image) }}" class="rounded-circle img-raised">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="material_id" id="material_id" onchange="materialchanges()" class="form-control show-tick"
                                                        ...
                                                        @foreach ($material_stock_record as $mat)
                                                            @if ($mat->site_id == $wastage->site_id)
                                                                @if ($mat->id == $wastage->material_id)
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="unit" id="unit_id" class="form-control show-tick"
                                                        data-live-search="true" required>
                                                        @foreach ($material_stock_record as $mat)
                                                            @if ($mat->site_id == $wastage->site_id && $mat->material_id == $wastage->material_id)
                                                                @if ($mat->unit == $wastage->unit)
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" placeholder="0.00" required
                                                        value={{ $wastage->qty }} class="form-control" name="qty"
